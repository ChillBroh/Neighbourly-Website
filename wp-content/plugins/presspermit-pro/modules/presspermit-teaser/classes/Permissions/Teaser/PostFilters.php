...
class PostFilters
{
    ...
    function fltRelevanssiContent($content, $post, $search_string) {
        ...
        $_query_obj = new \WP_Query(['s' => $search_string, 'suppress_filters' => true]);
    ...
    function fltGetTeaserPostTypes($tease_types = [], $post_types = [], $args = [])
    {
        ...
        if (is_admin() || $pp->isContentAdministrator() || (is_feed() && defined('PP_NO_FEED_TEASER')) || defined('XMLRPC_REQUEST') || defined('REST_REQUEST') 
