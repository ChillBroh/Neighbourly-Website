=== PublishPress Permissions Pro: Control Access for Posts, Pages, Categories, Tags ===
...
* Fixed : Statuses - Eliminate STATUS IN query which checked for custom post status usage. Instead, introduce checkbox to enable / disable Visibility Statuses if PublishPress and Gutenberg are active.
...
= 3.1.8-beta - 14 May 2020 =
* Compat : PublishPress Permissions - Fatal error on post creation
* Fixed : Fatal error on key activation error
