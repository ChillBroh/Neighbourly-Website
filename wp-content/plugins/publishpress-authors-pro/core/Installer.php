...
class Installer
{
    ...
    private static function get_pro_social_custom_fields() 
    {
        ...
        //add Twitter
        $social_custom_fields['twitter'] = [
            'post_title'   => __('Twitter', 'publishpress-authors-pro'),
            'post_name'    => 'twitter',
            'type'         => 'url',
            'social_profile'  => 1,
            'field_status'  => 'off',
            'description'  => __('Please enter the full URL to your Twitter profile.', 'publishpress-authors-pro'),
        ];
        //add Instagram
